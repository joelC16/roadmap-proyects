...
export default function Home() {
  ...
  // Numero de work/long-break/short-break
  let [countWork, setCountWork] = useState(-1);
  let [countLong, setCountLong] = useState(-1);
  let [countShort, setCountShort] = useState(-1);
